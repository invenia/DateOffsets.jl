...
If given a `window` the `sim_now`s are generated by stepping back from `global_sim_now` by
...
72×2 Array{AnchoredInterval{Hour(-1),ZonedDateTime,Open,Closed},2}:
 ...
 (2016-08-10 HE10-05:00]  (2016-08-13 HE10-05:00]
 ⋮
 (2016-08-08 HE16-05:00]  (2016-08-11 HE16-05:00]
 (2016-08-08 HE17-05:00]  (2016-08-11 HE17-05:00]
 (2016-08-08 HE18-05:00]  (2016-08-11 HE18-05:00]
 (2016-08-08 HE19-05:00]  (2016-08-11 HE19-05:00]
 (2016-08-08 HE20-05:00]  (2016-08-11 HE20-05:00]
 (2016-08-08 HE21-05:00]  (2016-08-11 HE21-05:00]
 (2016-08-08 HE22-05:00]  (2016-08-11 HE22-05:00]
 (2016-08-08 HE23-05:00]  (2016-08-11 HE23-05:00]
 (2016-08-08 HE24-05:00]  (2016-08-11 HE24-05:00]
...
function observations(
    ...
    for (i, offset) in enumerate(offsets)
        o[:, i] = map(dt -> offset(OffsetOrigins(dt, sim_now, global_sim_now)), o[:, i])
    end
...
function observations(
    ...
    tuple = map((s) -> observations(offsets, horizon, s, global_sim_now), sim_now)
...
function observations(
    ...
    return observations(offsets, horizon, sim_now .- window, sim_now)
end

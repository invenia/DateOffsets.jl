#=
intervals.jl is sourced from AxisArrays.jl
https://github.com/mbauman/AxisArrays.jl
Copyright Matt Bauman and other contributors, used under the MIT "Expat" License.
https://github.com/mbauman/AxisArrays.jl/blob/master/LICENSE.md
=#
